    ...
    def __show_table_report(self):
        ...
        for name, experiment in self.__repo:
            table.append([
                ...
                self.__short_format(experiment.metric.Confusion_matrix.Accuracy),
        ...
        print(tabulate(table, headers=['Name model','Threshold', 'F-Score', 'Precision', 'Recall', 'Accuracy', 'Roc-AUC', 'f1-score(macro)']))
